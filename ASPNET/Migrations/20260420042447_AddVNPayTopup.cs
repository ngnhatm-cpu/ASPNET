...
{
    /// <inheritdoc />
    public partial class AddVNPayTopup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    XuAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    VNPayTranId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
